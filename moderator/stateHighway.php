                ...
                <div class="col-lg-6">
                  <div class="card mb-0">
                    <div class="card-header">
                      ...
                      <h3 class="h4 mb-0">state road 1</h3>
                    </div>
                    <div class="card-body">
                ...
                <div class="col-lg-6">
                  <div class="card mb-0">
                    <div class="card-header">
                      ...
                      <h3 class="h4 mb-0">state road 2</h3>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                ...
                <div class="col-lg-6">
                  <div class="card mb-0">
                    <div class="card-header">
                      ...
                      <h3 class="h4 mb-0">state road 3</h3>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                ...
                <div class="col-lg-6">
                  <div class="card mb-0">
                    <div class="card-header">
                      ...
                      <h3 class="h4 mb-0">state road 4</h3>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                ...
                <div class="col-lg-6">
                  <div class="card mb-0">
                    <div class="card-header">
                      ...
                      <h3 class="h4 mb-0">state road 5</h3>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table mb-0 table-striped table-sm">
