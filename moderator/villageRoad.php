        ...
        <div class="content-inner w-100">
          ...
          <header class="bg-white shadow-sm px-4 py-3 z-index-20">
            <div class="container-fluid px-0">
              <h2 class="mb-0 p-1">Village Road</h2>
            </div>
          </header>
          <!-- Breadcrumb-->
          <div class="bg-white">
            <div class="container-fluid">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 py-3">
                  ...
                  <li class="breadcrumb-item active fw-light" aria-current="page">Village Road</li>
                </ol>
              </nav>
            </div>
          </div>
                ...
                <div class="col-lg-6">
                  <div class="card mb-0">
                    <div class="card-header">
                      ...
                      <h3 class="h4 mb-0">village road 1</h3>
                    </div>
                    <div class="card-body">
                ...
                <div class="col-lg-6">
                  <div class="card mb-0">
                    <div class="card-header">
                      ...
                      <h3 class="h4 mb-0">village road 2</h3>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                ...
                <div class="col-lg-6">
                  <div class="card mb-0">
                    <div class="card-header">
                      ...
                      <h3 class="h4 mb-0">village road 3</h3>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                ...
                <div class="col-lg-6">
                  <div class="card mb-0">
                    <div class="card-header">
                      ...
                      <h3 class="h4 mb-0">village road 4</h3>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
